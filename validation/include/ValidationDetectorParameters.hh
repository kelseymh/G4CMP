////////////////////////////////////////////////////////
//
// ValidationDetectorParameters.hh
//
// linehan3@fnal.gov
...
namespace ValidationDetectorParameters
{
  //----------------------------------------------------------------
  //Overall World
  ...
  //----------------------------------------------------------------
  //Validation Geometry 1 dimensions
  constexpr double dp_siThickness = 1.0 * CLHEP::mm;
  constexpr double dp_geThickness = 1.0 * CLHEP::mm;
  constexpr double dp_aluminum1Thickness = 100 * CLHEP::nm;
  constexpr double dp_aluminum2Thickness = 1 * CLHEP::mm;
