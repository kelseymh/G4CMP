...
#ifndef G4CMPChanneling_h
#define G4CMPChanneling_h 1
...
class G4CMPChanneling : public G4VDiscreteProcess
{
public:
    
    G4CMPChanneling(const G4String& processName = "G4CMPChanneling" );
    
    virtual ~G4CMPChanneling();
...
private:
    ...
    G4CMPChanneling& operator=(const G4CMPChanneling& right);
