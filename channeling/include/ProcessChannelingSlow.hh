...
#ifndef ProcessChannelingSlow_h
#define ProcessChannelingSlow_h 1
...
class ProcessChannelingSlow : public G4VDiscreteProcess
{
public:
    
    ProcessChannelingSlow(const G4String& processName = "ProcessChannelingSlow" );
    
    virtual ~ProcessChannelingSlow();
...
private:
    ...
    ProcessChannelingSlow& operator=(const ProcessChannelingSlow& right);
