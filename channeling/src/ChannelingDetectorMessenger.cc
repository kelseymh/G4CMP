...
// ********************************************************************
//
/// \file analysis/A01/src/ChannelingDetectorMessenger.cc
/// \brief Implementation of the ChannelingDetectorMessenger class
//
// $Id$
// --------------------------------------------------------------
//
...
ChannelingDetectorMessenger::ChannelingDetectorMessenger(ChannelingDetectorConstruction* mpga)
:fTarget(mpga)
{
...
ChannelingDetectorMessenger::~ChannelingDetectorMessenger()
{
...
void ChannelingDetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValue)
{
...
G4String ChannelingDetectorMessenger::GetCurrentValue(G4UIcommand * command)
{
    G4String cv;
