...
XWrapperDiscreteProcess::XWrapperDiscreteProcess(XWrapperDiscreteProcess& right): G4VDiscreteProcess(right){
    ;
}
...
void XWrapperDiscreteProcess::RegisterProcess(G4VDiscreteProcess* toRegister, G4int flag){
    fRegisteredProcess = toRegister;
...
G4double XWrapperDiscreteProcess::GetDensity(const G4Track& aTrack){
    ...
    if(chanInfo){
        ...
        G4cout << G4endl << "XWrapperDiscreteProcess:: ERROR - no ChannelingParticleUserInfo object Detected" << G4endl;
    }
