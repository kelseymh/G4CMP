...
ProcessChannelingSlow::ProcessChannelingSlow(const G4String& aName):G4VDiscreteProcess(aName){
    fLatticeManager = XLatticeManager3::GetXLatticeManager();
    
    G4double kCarTolerance = G4GeometryTolerance::GetInstance()->GetSurfaceTolerance();
    G4cout<<"\n ProcessChannelingSlow::Constructor: Geometry surface tolerance is: " << kCarTolerance / mm << " mm"<<std::endl;
    if(verboseLevel>1) {
...
ProcessChannelingSlow::~ProcessChannelingSlow(){
    fFileOut.close();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

ProcessChannelingSlow::ProcessChannelingSlow(ProcessChannelingSlow& right):G4VDiscreteProcess(right){
    ;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::SetFileName(const G4String& vFilename){
...
G4String ProcessChannelingSlow::GetFileName(){
    return fFileName;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::PrintChannelingPropertiesOnFile(const G4Track& aTrack){
    if(fFileOut){
...
XVCrystalCharacteristic* ProcessChannelingSlow::GetPotential(){
    return fPotentialEnergy;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::SetPotential(XVCrystalCharacteristic* vPotential){
    fPotentialEnergy = vPotential;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

XVCrystalCharacteristic* ProcessChannelingSlow::GetElectricField(){
    return fElectricField;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::SetElectricField(XVCrystalCharacteristic* vElectricField){
    fElectricField = vElectricField;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

XCrystalIntegratedDensityHub* ProcessChannelingSlow::GetIntegratedDensity(){
    return fIntegratedDensity;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::SetIntegratedDensity(XCrystalIntegratedDensityHub* vIntegratedDensity){
    fIntegratedDensity = vIntegratedDensity;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::UpdateParameters(const G4Track& aTrack){
...
void ProcessChannelingSlow::UpdatePosition(const G4Track& aTrack){
...
void ProcessChannelingSlow::UpdateMomentum(const G4Track& aTrack){
...
void ProcessChannelingSlow::ResetDensity(const G4Track& aTrack){
...
G4ThreeVector ProcessChannelingSlow::ComputePositionInTheCrystal(G4StepPoint* vStep,const G4Track& aTrack){
...
G4StepPoint* ProcessChannelingSlow::CheckStepPointLatticeForVolume(G4StepPoint* vStep, const G4Track& aTrack){
...
G4StepPoint* ProcessChannelingSlow::CheckStepPointLatticeForPosition(G4StepPoint* vStep, const G4Track& aTrack){
...
G4double ProcessChannelingSlow::GetChannelingMeanFreePath(const G4Track& aTrack){
    //----------------------------------------
...
G4double ProcessChannelingSlow::GetMeanFreePath(const G4Track& aTrack,
...
G4VParticleChange* ProcessChannelingSlow::PostStepDoIt(const G4Track& aTrack,
                                                       const G4Step&){
...
G4ThreeVector ProcessChannelingSlow::ComputeTransverseEnergy(const G4Track& aTrack){
    //----------------------------------------
...
G4ThreeVector ProcessChannelingSlow::ComputeKineticEnergy(const G4Track& aTrack){
    //----------------------------------------
...
G4ThreeVector ProcessChannelingSlow::ComputePotentialEnergy(const G4Track& aTrack){
    //----------------------------------------
    // compute the particle transverse energy
    // in the crystal reference system
    //----------------------------------------
...
G4ThreeVector ProcessChannelingSlow::ComputeCentrifugalEnergy(const G4Track& aTrack,G4ThreeVector vPosition){
    //----------------------------------------
...
G4ThreeVector ProcessChannelingSlow::ComputeMomentum(const G4Track& aTrack,G4StepPoint* vStep){
    //----------------------------------------
...
G4double ProcessChannelingSlow::ComputeCriticalEnergyMaximum(const G4Track& aTrack){
    //----------------------------------------
...
G4double ProcessChannelingSlow::ComputeCriticalEnergyMinimum(const G4Track& aTrack){
    //----------------------------------------
...
G4double ProcessChannelingSlow::ComputeCriticalAngle(const G4Track& aTrack){
    //----------------------------------------
...
G4double ProcessChannelingSlow::ComputeOscillationPeriod(const G4Track& aTrack){
    //----------------------------------------
...
G4double ProcessChannelingSlow::ComputeCriticalRadius(const G4Track& aTrack){
    //----------------------------------------
...
G4ThreeVector ProcessChannelingSlow::ComputePotentialWellCentre(const G4Track& aTrack){
    //----------------------------------------
...
G4bool ProcessChannelingSlow::IsApplicable(const G4ParticleDefinition& aPD){
    return(aPD.GetPDGCharge() != 0.);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::BuildPhysicsTable(const G4ParticleDefinition&){
    
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

XPhysicalLattice* ProcessChannelingSlow::GetXPhysicalLattice(const G4Track& aTrack){
...
G4bool ProcessChannelingSlow::HasLattice(const G4Track& aTrack){
    if(fLatticeManager->HasLattice(aTrack.GetStep()->GetPostStepPoint()->GetPhysicalVolume())){
        return true;
    }
    else{
...
G4bool ProcessChannelingSlow::HasLatticeOnBoundary(const G4Track& aTrack){
...
G4bool ProcessChannelingSlow::ParticleIsNegative(const G4Track& aTrack){
...
G4bool ProcessChannelingSlow::ParticleIsCrossingPlane(const G4Track& aTrack){
...
G4bool ProcessChannelingSlow::ParticleIsNotOnBoundary(const G4Track& aTrack){
...
ChannelingParticleUserInfo* ProcessChannelingSlow::GetInfo(const G4Track& aTrack){
    return (ChannelingParticleUserInfo*) aTrack.GetUserInformation();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4ParticleDefinition* ProcessChannelingSlow::GetParticleDefinition(const G4Track& aTrack){
    return const_cast<G4ParticleDefinition*>(aTrack.GetParticleDefinition());
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ProcessChannelingSlow::ComputeCrystalCharacteristic(const G4Track& aTrack){
...
void ProcessChannelingSlow::PrintCrystalCharacteristicsOnFiles(const G4Track& aTrack){
