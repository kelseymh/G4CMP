...
void XCrystalIntegratedDensityHub::SetIntegratedDensityNuclei(XVCrystalIntegratedDensity* vDensity,G4int vParticleCharge){
    if(vParticleCharge < 0){
        ...
        G4cout << "XCrystalIntegratedDensityHub:: ERROR  - Charge == 0" << std::endl;
    }
}
...
void XCrystalIntegratedDensityHub::SetIntegratedDensityElectron(XVCrystalIntegratedDensity* vDensity,G4int vParticleCharge){
    if(vParticleCharge < 0){
...
G4double XCrystalIntegratedDensityHub::GetIntegratedDensityNuclei(G4double vPotential, XPhysicalLattice* vLattice, G4int vParticleCharge){
    if(vParticleCharge < 0.){
        return fIntDensNucleiNegative->GetIntegratedDensity(vPotential,vLattice,vParticleCharge);
    }
    else if(vParticleCharge > 0.){
        return fIntDensNucleiPositive->GetIntegratedDensity(vPotential,vLattice,vParticleCharge);
    }
    else{
        G4cout << "XCrystalIntegratedDensityHub:: ERROR  - Charge == 0" << std::endl;
        return -1;
...
G4double XCrystalIntegratedDensityHub::GetIntegratedDensityElectron(G4double vPotential, XPhysicalLattice* vLattice, G4int vParticleCharge){
    if(vParticleCharge < 0.){
        return fIntDensElectronNegative->GetIntegratedDensity(vPotential,vLattice,vParticleCharge);
    }
    else if(vParticleCharge > 0.){
        return fIntDensElectronPositive->GetIntegratedDensity(vPotential,vLattice,vParticleCharge);
    }
    else{
        G4cout << "XCrystalIntegratedDensityHub:: ERROR  - Charge == 0" << std::endl;
        return -1;
