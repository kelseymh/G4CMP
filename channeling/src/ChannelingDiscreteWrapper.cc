...
ChannelingDiscreteWrapper::ChannelingDiscreteWrapper(const G4String& aName)
...
ChannelingDiscreteWrapper::ChannelingDiscreteWrapper(const G4String&, G4VDiscreteProcess* toRegister)
:G4VDiscreteProcess("ChannelingDiscreteWrapper"){
...
ChannelingDiscreteWrapper::ChannelingDiscreteWrapper(ChannelingDiscreteWrapper& right): G4VDiscreteProcess(right){
    ;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ChannelingDiscreteWrapper::RegisterProcess(G4VDiscreteProcess* toRegister){
    fRegisteredProcess = toRegister;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ChannelingDiscreteWrapper::RegisterProcess(G4VDiscreteProcess* toRegister, G4int flag){
    fRegisteredProcess = toRegister;
...
void ChannelingDiscreteWrapper::SetNucleiOrElectronFlag(G4int flag){
    bNucleiOrElectronFlag = flag;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4int ChannelingDiscreteWrapper::GetNucleiOrElectronFlag(){
    return bNucleiOrElectronFlag;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4double ChannelingDiscreteWrapper::GetDensity(const G4Track& aTrack){
    ...
    if(chanInfo){
        ...
        G4cout << G4endl << "ChannelingDiscreteWrapper:: ERROR - no ChannelingParticleUserInfo object Detected" << G4endl;
    }
...
G4double ChannelingDiscreteWrapper::GetDensityPreviousStep(const G4Track& aTrack){
    //Retrieve nuclei and electron density from ChannelingParticleUserInfo object
    ChannelingParticleUserInfo* chanInfo = (ChannelingParticleUserInfo*) aTrack.GetUserInformation();
...
void ChannelingDiscreteWrapper::StartTracking(G4Track* aTrack){
...
G4double ChannelingDiscreteWrapper::GetMeanFreePath(const G4Track&,
...
G4double ChannelingDiscreteWrapper::PostStepGetPhysicalInteractionLength (const G4Track &aTrack,
                                                                        G4double previousStepSize,
...
G4VParticleChange* ChannelingDiscreteWrapper::PostStepDoIt(const G4Track& aTrack,
                                                         const G4Step& aStep ){
...
G4bool ChannelingDiscreteWrapper::IsApplicable(const G4ParticleDefinition& aParticleDefinition){
    return fRegisteredProcess->IsApplicable(aParticleDefinition);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ChannelingDiscreteWrapper::BuildPhysicsTable(const G4ParticleDefinition& aParticleDefinition){
    fRegisteredProcess->BuildPhysicsTable(aParticleDefinition);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ChannelingDiscreteWrapper::PreparePhysicsTable(const G4ParticleDefinition& aParticleDefinition){
    fRegisteredProcess->PreparePhysicsTable(aParticleDefinition);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4bool ChannelingDiscreteWrapper::StorePhysicsTable(const G4ParticleDefinition* aParticleDefinition,
...
G4bool ChannelingDiscreteWrapper::RetrievePhysicsTable( const G4ParticleDefinition* aParticleDefinition,
                                                     const G4String& aString,
                                                     G4bool aBool){
