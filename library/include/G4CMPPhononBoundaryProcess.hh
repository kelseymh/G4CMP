...
// 20250204  N. Tenpas -- Support reflection displacement search at hard
// corners. 20250325  N. Tenpas -- Add support for macro commands to set step
// size and limit. 20250422  N. Tenpas -- Add position argument to
// GetLambertianVector. 20250423  G4CMP-468 -- Add wrapper function for updating
// navigator. 20250423  G4CMP-468 -- Move GetLambertianVector to G4CMPUtils.
...
public:
  G4CMPPhononBoundaryProcess(
      const G4String& processName = "G4CMPPhononBoundary");
...
protected:
  ...
  virtual G4bool DoLatticeInterface(const G4Track& aTrack, const G4Step& aStep,
  ...
  void DoDiffuseTransmission(const G4Track& aTrack, const G4Step& aStep,
                             G4ParticleChange& particleChange);
