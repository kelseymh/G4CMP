...
G4CMPConfigManager::G4CMPConfigManager()
  : voltage(getenv("G4CMP_VOLTAGE")?strtod(getenv("G4CMP_VOLTAGE"),0)*volt:0.),
    ...
    phononMinE(getenv("G4CMP_MIN_PHON_E")?strtod(getenv("G4CMP_MIN_PHON_E"),0):0),
    elecMinE(getenv("G4CMP_MIN_ELEC_E")?strtod(getenv("G4CMP_MIN_ELEC_E"),0):0),
    holeMinE(getenv("G4CMP_MIN_HOLE_E")?strtod(getenv("G4CMP_MIN_HOLE_E"),0):0),
