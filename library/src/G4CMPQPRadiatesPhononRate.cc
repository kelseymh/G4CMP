...
G4double G4CMPQPRadiatesPhononRate::Rate(const G4Track& aTrack) const
{
  ...
  G4double tau_scattering = fTau0_qp*(this->GetTauAsAFunctionOfEnergy(fCurrentNormalizedTauQPRadiatesPhononVsEnergy,"QP",energy,thisEnergyBelowUsableRange));
...
bool G4CMPQPRadiatesPhononRate::CheckToSeeSCParametersSet() const {
