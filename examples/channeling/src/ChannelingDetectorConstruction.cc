...
ChannelingDetectorConstruction::ChannelingDetectorConstruction():fWorldLogic(0),fXtalLogic(0){
    ...
    fMessenger = new ChannelingDetectorMessenger(this);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo.....

ChannelingDetectorConstruction::~ChannelingDetectorConstruction(){
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo.....

void ChannelingDetectorConstruction::DefineMaterials(){
...
G4VPhysicalVolume* ChannelingDetectorConstruction::Construct(){
...
void ChannelingDetectorConstruction::ConstructWorld(){
...
void ChannelingDetectorConstruction::AddSiliconStripDetectors(G4String vDetectorString) {
...
void ChannelingDetectorConstruction::ConstructRBSDetector(){
    ...
    G4String SDname;
    G4VSensitiveDetector* detectorRBS = new ChannelingDriftChamber(SDname="/detectorRBS");
...
void ChannelingDetectorConstruction::ConstructScintillators(){
    ...
    G4String SDname;
    G4VSensitiveDetector* telescope = new ChannelingDriftChamber(SDname="/scintillator");
...
void ChannelingDetectorConstruction::ConstructSiliconStripDetectors(){
    G4Material* Si = G4NistManager::Instance()->FindOrBuildMaterial("G4_Si");
    ...
    G4String SDname;
    G4VSensitiveDetector* telescope = new ChannelingDriftChamber(SDname="/telescope");
    G4SDManager::GetSDMpointer()->AddNewDetector(telescope);
...
void ChannelingDetectorConstruction::ConstructXtalTarget(){
...
void ChannelingDetectorConstruction::SetWorldMaterial(const G4String& name){
...
G4String ChannelingDetectorConstruction::GetWorldMaterial(){
    if(fXtalMaterial) {
...
void ChannelingDetectorConstruction::SetXtalMaterial(const G4String& name){
    G4Material* vMaterial = G4Material::GetMaterial(name, false);
...
G4String ChannelingDetectorConstruction::GetXtalMaterial(){
    if(fXtalMaterial) {
...
void ChannelingDetectorConstruction::SetSSDSize(G4ThreeVector size){
    if(fSSDSize != size) {
        G4RunManager::GetRunManager()->GeometryHasBeenModified();
        fSSDSize = size;
    }
...
void ChannelingDetectorConstruction::SetSSD0XtalDistance(G4double distance) {
...
void ChannelingDetectorConstruction::SetSSD1XtalDistance(G4double distance) {
...
void ChannelingDetectorConstruction::SetSSD2XtalDistance(G4double distance) {
...
void ChannelingDetectorConstruction::SetSCISize(G4ThreeVector size){
    if(fSCISize != size) {
        G4RunManager::GetRunManager()->GeometryHasBeenModified();
        fSCISize = size;
    }
...
void ChannelingDetectorConstruction::SetSCIRelativeDistance(G4double distance) {
...
void ChannelingDetectorConstruction::SetSCIXtalDistance(G4double distance) {
...
void ChannelingDetectorConstruction::SetRBSDistanceR(G4double distance) {
...
void ChannelingDetectorConstruction::SetRBSAngleTheta(G4double angle) {
...
void ChannelingDetectorConstruction::SetRBSAnglePhi(G4double angle) {
    if(fRBSAnglePhi != angle) {
        G4RunManager::GetRunManager()->GeometryHasBeenModified();
        fRBSAnglePhi = angle;
        G4cout << "ChannelingDetectorConstruction::SetRBSAnglePhi() - New Phi = " << fRBSAnglePhi/CLHEP::degree << G4endl;
    }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void ChannelingDetectorConstruction::SetXtalCurvatureRadius(G4ThreeVector cr) {
...
void ChannelingDetectorConstruction::SetXtalSize(G4ThreeVector size) {
    if(fXtalSize != size) {
        G4RunManager::GetRunManager()->GeometryHasBeenModified();
        fXtalSize = size;
    }
...
void ChannelingDetectorConstruction::SetXtalAngle(G4ThreeVector angle) {
    if(fXtalAngle != angle) {
        G4RunManager::GetRunManager()->GeometryHasBeenModified();
        fXtalAngle = angle;
    }
...
void ChannelingDetectorConstruction::SetXtalCellSize(G4ThreeVector cellsize) {
...
void ChannelingDetectorConstruction::SetXtalCellAngle(G4ThreeVector cellangle) {
...
void ChannelingDetectorConstruction::SetXtalThermalVibrationAmplitude(G4double thermvibr) {
