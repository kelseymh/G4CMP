...
// Primary Constructor
QuasiparticlePad::QuasiparticlePad(G4RotationMatrix * pRot,
...
void QuasiparticlePad::ConstructPad(G4RotationMatrix * pRot,
				    const G4ThreeVector & tLate,
				    const G4String & pName,
				    G4LogicalVolume * pMotherLogical,
				    G4bool pMany,
				    ...
				    G4bool pSurfChk)
{
  ...
  //Also, create a dedicated lattice for this.
  ...
  new G4CMPLogicalBorderSurface(boundaryName1, phys_padConductor, phys_padEmpty,AlVacBoundary);
  new G4CMPLogicalBorderSurface(boundaryName2, phys_padEmpty, phys_padConductor,AlVacBoundary);

  
  //Push these back into the fundamental volume list. These will also serve as the things we need to establish boundaries for
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<std::tuple<std::string,G4String,G4VPhysicalVolume*> > QuasiparticlePad::GetListOfAllFundamentalSubVolumes()
{
