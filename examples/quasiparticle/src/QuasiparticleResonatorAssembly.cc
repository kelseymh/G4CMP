...
MakeResonatorLine(G4String pName, G4LogicalVolume * log_baseAlLayer,
  ...
  G4UnionSolid * solid_shuntCouplerMerge2Conductor =
    new G4UnionSolid("shuntCouplerHorizontalPlusNubPlusLeft",
		     ...
		     G4ThreeVector(-0.5*dp_shuntCouplerHorizontalConductorDimX + 0.5*dp_shuntCouplerLobeConductorDimX,
				   0.5*(dp_shuntCouplerHorizontalConductorDimY+dp_shuntCouplerLobeConductorDimY),0));
