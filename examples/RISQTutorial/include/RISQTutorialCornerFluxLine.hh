...
#ifndef RISQTutorialCornerFluxLine_h
#define RISQTutorialCornerFluxLine_h 1
...
class RISQTutorialCornerFluxLine
{
  public:
    RISQTutorialCornerFluxLine();
    ~RISQTutorialCornerFluxLine();
    ...
    RISQTutorialCornerFluxLine(G4RotationMatrix * pRot,
