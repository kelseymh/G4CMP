...
//
//
/// \file RISQTutorialQubitHousing.hh
/// \brief Definition of the class defining shield type A for the
///        QUIET fridge

#ifndef RISQTutorialQubitHousing_h
#define RISQTutorialQubitHousing_h 1
...
class RISQTutorialQubitHousing
{
  public:
    RISQTutorialQubitHousing();
    ~RISQTutorialQubitHousing();
    ...
    RISQTutorialQubitHousing(G4RotationMatrix * pRot,
