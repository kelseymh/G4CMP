...
#ifndef RISQTutorialResonatorAssembly_h
#define RISQTutorialResonatorAssembly_h 1
...
class RISQTutorialResonatorAssembly
{
  public:
    RISQTutorialResonatorAssembly();
    ~RISQTutorialResonatorAssembly();
    ...
    RISQTutorialResonatorAssembly(G4RotationMatrix * pRot,
