...
#ifndef RISQTutorialStraightFluxLine_h
#define RISQTutorialStraightFluxLine_h 1
...
class RISQTutorialStraightFluxLine
{
  public:
    RISQTutorialStraightFluxLine();
    ~RISQTutorialStraightFluxLine();
    ...
    RISQTutorialStraightFluxLine(G4RotationMatrix * pRot,
