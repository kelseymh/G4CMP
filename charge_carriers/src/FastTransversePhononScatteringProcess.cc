...
#include "FastTransversePhononScatteringProcess.hh"
#include "G4Step.hh"
...
FastTransversePhononScatteringProcess::FastTransversePhononScatteringProcess(const G4String& aName)
...
FastTransversePhononScatteringProcess::FastTransversePhononScatteringProcess(FastTransversePhononScatteringProcess& right)
: G4VDiscreteProcess(right)
{;}
 
G4double 
FastTransversePhononScatteringProcess::GetMeanFreePath( 
...
///////////////////////////////////////////////////////////////////////////
  ...
  //G4cout<<"\nFastTransversePhononScatteringCrossSection::GetMeanFreePath: B E^4/h^4 calculated as: "<<((E/h)*(E/h)*(E/h)*(E/h)*B)<<" Velocity found: "<<aTrack.GetVelocity();
...
G4VParticleChange*
  FastTransversePhononScatteringProcess::PostStepDoIt( const G4Track& aTrack,
                                 const G4Step&  )
{
  ...
  newDir=LatticeManager2::mapKtoVDir(aTrack.GetVolume(), FT, newDir);
...
G4bool FastTransversePhononScatteringProcess::IsApplicable(const G4ParticleDefinition& aPD)
{
